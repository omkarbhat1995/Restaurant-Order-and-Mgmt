<?php 
    ...
    { 
        ...
        // their username. 
        $query = " SELECT Email_id,Emp_id,Password FROM Employee WHERE Email_id = :username"; 
...
//        $sql3="INSERT INTO loggedin (username) VALUES ('$u')";
  //      if (!mysqli_query($link,$sql3)){die('Error'.mysqli_error($link));}
        ...
        { 
			...
			$url="empinfo.php?username=".$u."&id=".$id;
            header("Location: ".$url); 
		...
		<div class="col-md-12 contact">
			<nav>
		 	...
		 	<div class="main-part" align="center">
			 	...
			 	<hr>
						<form action="emplog.php" method="post" align="center"> 
							Username:<br /> 
